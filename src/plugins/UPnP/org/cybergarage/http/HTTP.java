...
*       - Problem : the method getPort should return the default http port 80 when a port is not
*         specified
*       - Description : the method is used in ControlRequest.setRequestHost() and in
