...
*   07/02/04
*       - Fixed announce() and byebye() to send the upnp::rootdevice message despite
*         embedded devices.
...
*   03/22/05
*       - Changed httpPostRequestRecieved() to return the bad request when the post request isn't
*         the soap action.
*   03/23/05
...
*   04/25/05
*       - Thanks for Mikael Hakman <mhakman@dkab.net>
*         Changed deviceSearchResponse() answer with USN:UDN::<device-type> when request ST
*         is device type.
*   04/25/05
*       - Thanks for Mikael Hakman <mhakman@dkab.net>
